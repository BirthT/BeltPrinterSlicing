...
class USBPrinterOutputDevicePatches():
    def __init__(self, output_device):
        ...
        self._not_supported_message = Message(i18n_catalog.i18nc("@info:status", "Printing via USB is not supported on BELT 3D printers. Please save the G-code to an SD-Card."))
