    ...
    def run(self):
        ...
        for layer in self._layers:
            ...
            for p in range(layer.repeatedMessageCount("path_segment")):
                ...
                if self._preferences.getValue("BeltPlugin/belt_wall_enabled"):
                    belt_wall_feedrate = self._preferences.getValue("BeltPlugin/belt_wall_speed")
                    belt_wall_indices = []
        ...
        if transform and transform != Matrix():
            ...
            if self._preferences.getValue("BeltPlugin/raft"):
                front_offset = front_offset - self._preferences.getValue("BeltPlugin/raft_margin") \
                                            - self._preferences.getValue("BeltPlugin/raft_thickness")
